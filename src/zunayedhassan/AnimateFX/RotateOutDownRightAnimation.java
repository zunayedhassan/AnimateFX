 ...
 */
public class RotateOutDownRightAnimation extends AnimationFX {
    protected Rotate rotate = null;
    
    public RotateOutDownRightAnimation(Node node, double width, double height) {
        super(node);
        
        this.rotate = new Rotate(0, width, height);
    ...
    @Override
    public void Play() {
        this.rotate.angleProperty().set(0);
