 ...
 */
public class RotateInDownLeftAnimation extends AnimationFX {
    protected Rotate rotate = null;
    
    public RotateInDownLeftAnimation(Node node, double height) {
        super(node);
        ...
        this.timeline = new Timeline(
                ...
                new KeyValue(this.rotate.angleProperty(), -90, WEB_EASE)
            ),
            new KeyFrame(Duration.millis(1000),    
                new KeyValue(node.opacityProperty(), 1, WEB_EASE),
                new KeyValue(this.rotate.angleProperty(), 0, WEB_EASE)
            )
        );
